...
public:
    ...
    void setToDefault(void) {
        ...
        set(Level::Debug, ConfigurationType::Format, std::string("%datetime | %level | %msg"));
        ...
        set(Level::Verbose, ConfigurationType::Format, std::string("%datetime | %level | %msg"));
        set(Level::Trace, ConfigurationType::Format, std::string("%datetime | %level | %msg"));
    }
