...
namespace resurgence
{
    namespace system
    {
        ...
        void process_memory::read_bytes(std::uint8_t* address, std::uint8_t* buffer, std::size_t size)
        {
        ...
        void process_memory::write_bytes(std::uint8_t* address, std::uint8_t* buffer, std::size_t size)
        {
